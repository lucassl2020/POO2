...
# Form implementation generated from reading ui file 'tela_de_saque.ui'
#
...
"color: rgb(23, 14, 121);")
        ...
        self.valor_a_ser_sacado_line = QtWidgets.QLineEdit(self.frame_2)
        self.valor_a_ser_sacado_line.setGeometry(QtCore.QRect(290, 70, 221, 20))
        self.valor_a_ser_sacado_line.setObjectName("valor_a_ser_sacado_line")
        self.valor_a_ser_sacado_label = QtWidgets.QLabel(self.frame_2)
        self.valor_a_ser_sacado_label.setGeometry(QtCore.QRect(120, 60, 161, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.valor_a_ser_sacado_label.setFont(font)
        self.valor_a_ser_sacado_label.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.valor_a_ser_sacado_label.setObjectName("valor_a_ser_sacado_label")
...
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.valor_a_ser_sacado_label.setText(_translate("MainWindow", "Valor à ser sacado:"))
